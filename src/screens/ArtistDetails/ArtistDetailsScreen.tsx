    ...
    const renderSongItem = ({ item, index }: { item: Song; index: number }) => {
        ...
        return (
            <TouchableOpacity style={styles.songItem} onPress={() => handleSongPress(item)}>
                <Image source={
                    { uri: item.image[1]?.url || item.image[0]?.url }} style={styles.songImage} 
                />
                <View style={styles.songInfo}>
                    <Text style={
                        [styles.songName, isCurrent && styles.activeText]
                    } numberOfLines={1}>
                        {item.name}
                    </Text>
                    <Text 
    ...
    const Header = () => (
        <View style={styles.header}>
            <View style={styles.heroContainer}>
                ...
                >
                    ...
                    <View style={styles.artistInfoContainer}>
                        <Image source={
                            { uri: artist?.image[2]?.url || artist?.image[1]?.url 
                            }
                        } 
                        ...
                        >
                            {artist?.fanCount ? `${(artist.fanCount / 1000).toFixed(1)}K Fans` : 'Artist'} • {songs.length} 
                            Songs
                        </Text>
                    </View>
                </ImageBackground>
            ...
            <View style={styles.actionButtons}>
                <TouchableOpacity 
                style={
                    [styles.button, styles.shuffleButton]
                    ...
                    />
                    <Text 
                    style={styles.buttonText}>Shuffle
                    </Text>
                </TouchableOpacity>
                <TouchableOpacity 
                style={
            ...
            >
                <Text 
                style={styles.sectionTitle}>Popular Songs</Text>
            </View>
        </View>
    );
